...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_27.setToolTip(_translate("MainWindow", "Detects the presence of an audience in the recording. Higher liveness values represent an increased probability that the track was performed live. A value above 0.8 provides strong likelihood that the track is live."))
        self.label_27.setText(_translate("MainWindow", "liveness:"))
        self.label_33.setToolTip(_translate("MainWindow", "A measure from 0.0 to 1.0 describing the musical positiveness conveyed by a track. Tracks with high valence sound more positive (e.g. happy, cheerful, euphoric), while tracks with low valence sound more negative (e.g. sad, depressed, angry)."))
        self.label_33.setText(_translate("MainWindow", "valence:"))
        self.label_4.setText(_translate("MainWindow", "genre:"))
        self.label_30.setToolTip(_translate("MainWindow", "Speechiness detects the presence of spoken words in a track. The more exclusively speech-like the recording (e.g. talk show, audio book, poetry), the closer to 1.0 the attribute value. Values above 0.66 describe tracks that are probably made entirely of spoken words. Values between 0.33 and 0.66 describe tracks that may contain both music and speech, either in sections or layered, including such cases as rap music. Values below 0.33 most likely represent music and other non-speech-like tracks."))
        ...
        self.label_18.setToolTip(_translate("MainWindow", "Energy is a measure from 0.0 to 1.0 and represents a perceptual measure of intensity and activity. Typically, energetic tracks feel fast, loud, and noisy. For example, death metal has high energy, while a Bach prelude scores low on the scale. Perceptual features contributing to this attribute include dynamic range, perceived loudness, timbre, onset rate, and general entropy."))
        self.label_18.setText(_translate("MainWindow", "energy:"))
        self.label_10.setText(_translate("MainWindow", "track_name:"))
        self.label_29.setToolTip(_translate("MainWindow", "Mode indicates the modality (major or minor) of a track, the type of scale from which its melodic content is derived. Major is represented by 1 and minor is 0."))
        self.label_29.setText(_translate("MainWindow", "mode:"))
        self.label_15.setToolTip(_translate("MainWindow", "A confidence measure from 0.0 to 1.0 of whether the track is acoustic. 1.0 represents high confidence the track is acoustic."))
        self.label_15.setText(_translate("MainWindow", "acousticness:"))
        self.label_32.setToolTip(_translate("MainWindow", "An estimated time signature. The time signature (meter) is a notational convention to specify how many beats are in each bar (or measure). The time signature ranges from 3 to 7 indicating time signatures of \"3/4\", to \"7/4\"."))
        self.label_32.setText(_translate("MainWindow", "time_signature:"))
        self.label_16.setToolTip(_translate("MainWindow", "Danceability describes how suitable a track is for dancing based on a combination of musical elements including tempo, rhythm stability, beat strength, and overall regularity. A value of 0.0 is least danceable and 1.0 is most danceable."))
        self.label_16.setText(_translate("MainWindow", "danceability:"))
        self.label_28.setToolTip(_translate("MainWindow", "The overall loudness of a track in decibels (dB). Loudness values are averaged across the entire track and are useful for comparing relative loudness of tracks. Loudness is the quality of a sound that is the primary psychological correlate of physical strength (amplitude). Values typically range between -60 and 0 db."))
        self.label_28.setText(_translate("MainWindow", "loudness:"))
        self.label_14.setToolTip(_translate("MainWindow", "The popularity of the track. The value will be between 0 and 100, with 100 being the most popular.\n"
...
"Generally speaking, songs that are being played a lot now will have a higher popularity than songs that were played a lot in the past. Duplicate tracks (e.g. the same track from a single and an album) are rated independently. Artist and album popularity is derived mathematically from track popularity. Note: the popularity value may lag actual popularity by a few days: the value is not updated in real time."))
        ...
        self.label_31.setToolTip(_translate("MainWindow", "The overall estimated tempo of a track in beats per minute (BPM). In musical terminology, tempo is the speed or pace of a given piece and derives directly from the average beat duration."))
        self.label_31.setText(_translate("MainWindow", "tempo:"))
        self.label_26.setToolTip(_translate("MainWindow", "The key the track is in. Integers map to pitches using standard Pitch Class notation. E.g. 0 = C, 1 = C♯/D♭, 2 = D, and so on. If no key was detected, the value is -1."))
        self.label_26.setText(_translate("MainWindow", "key:"))
        self.label_17.setToolTip(_translate("MainWindow", "The duration of the track in milliseconds."))
        self.label_17.setText(_translate("MainWindow", "duration_ms:"))
        self.label_24.setToolTip(_translate("MainWindow", "Predicts whether a track contains no vocals. \"Ooh\" and \"aah\" sounds are treated as instrumental in this context. Rap or spoken word tracks are clearly \"vocal\". The closer the instrumentalness value is to 1.0, the greater likelihood the track contains no vocal content. Values above 0.5 are intended to represent instrumental tracks, but confidence is higher as the value approaches 1.0."))
